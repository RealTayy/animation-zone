...
class PBTransform {
	...
	transform(offset) {
		...
		const perpectiveCSS = (rotateXValue || rotateYValue) ? "perspective(500px)" : '';
	...
	resetPosition() {
		this.transformTarget.style.transform = (this.options.tiltX || this.options.tiltY) ? 'perspective(500px)' : '';
	};
